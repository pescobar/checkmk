...
discovery = {
    '': [
        ('HostSystem 10.1.1.111', {}), ('HostSystem 10.1.1.112', {}),
        ('VM Grafana', {}), ('VM Schulungs_ESXi', {}), ('VM Server', {}),
        ('VM virt1-1.4.2', {})
    ],
    'count': [(None, {})]
}
                ...
                'distribution': [
                    {
                        'hosts_count': 2,
                        'state': 2,
                        'vm_names': ['Grafana', 'Server']
                    }
                ]
            }, [
                (
                    0, 'Virtualmachines: 4', [
                        ('vms', 4, None, None, None, None)
                    ]
                ),
                ...
                'distribution': [
                    {
                        'hosts_count': 2,
                        'state': 2,
                        'vm_names': ['Grafana', 'Schulungs_ESXi']
                    }
                ]
            }, [
                (
