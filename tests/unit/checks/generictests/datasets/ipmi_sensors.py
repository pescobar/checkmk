...
discovery = {
    '': [('Power_Supply_PS_Status', {}), ('Power_Unit_PSU', {}), ('Temperature_Ambient', {})]
}

checks = {
    '': [('Power_Supply_PS_Status', {}, [(0, 'Status: Presence detected', [])]),
         ('Power_Unit_PSU', {}, [(2, 'Status: Redundancy Lost', [])]),
         ('Temperature_Ambient', {}, [(0, 'Status: OK, 20.0 C', [('value', 20.0, None, 42.0, None,
                                                                  None)])])]
=======
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
...
discovery = {
    '': [
        ('Power_Supply_PS_Status', {}), ('Power_Unit_PSU', {}),
        ('Temperature_Ambient', {})
    ]
}
...
checks = {
    '': [
        ...
        (
            'Temperature_Ambient', {}, [
                (0, 'Status: OK', []),
                (0, '20.00 C', [('value', 20.0, None, 42.0, None, None)])
            ]
        )
    ]
>>>>>>> upstream/master
